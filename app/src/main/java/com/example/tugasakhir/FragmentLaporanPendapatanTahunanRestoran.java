 ...
 * Use the {@link FragmentLaporanPendapatanTahunanRestoran#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentLaporanPendapatanTahunanRestoran extends Fragment {

    FragmentLaporanPendapatanTahunanRestoranBinding binding;
    ...
    public FragmentLaporanPendapatanTahunanRestoran() {
        // Required empty public constructor
    }

    public static FragmentLaporanPendapatanTahunanRestoran newInstance(String id_restoran) {
        FragmentLaporanPendapatanTahunanRestoran fragment = new FragmentLaporanPendapatanTahunanRestoran();
...
//        return inflater.inflate(R.layout.fragment_laporan_pendapatan_tahunan_restoran, container, false);
        binding = FragmentLaporanPendapatanTahunanRestoranBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.spinnerLaporanPendapatanTahunanRestoran.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                binding.textViewTahunLaporanPendapatanRestoran.setText(binding.spinnerLaporanPendapatanTahunanRestoran.getSelectedItem().toString());
            }
        ...
        binding.buttonSetTahunLaporanPendapatanRestoran.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void setRVLaporanPendapatanTahunan(){
        binding.rvLaporanPendapatanTahunanRestoran.setHasFixedSize(true);
...
//                                        }
                            ...
                            binding.rvLaporanPendapatanTahunanRestoran.setLayoutManager(new LinearLayoutManager(getActivity()));
                            LaporanPendapatanRestoranTahunanAdapter adapter = new LaporanPendapatanRestoranTahunanAdapter(arrHT3);
                            binding.rvLaporanPendapatanTahunanRestoran.setAdapter(adapter);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < arrHT.size(); i++) {
                                if(arrHT.get(i).getId_restoran().equalsIgnoreCase(id_restoran) && arrHT.get(i).getTanggal_reservasi().substring(6).equalsIgnoreCase(binding.spinnerLaporanPendapatanTahunanRestoran.getSelectedItem().toString())){
                                    HeaderTransaksi ht = new HeaderTransaksi(arrHT.get(i).getId_htrans_reservasi(), arrHT.get(i).getId_customer(), arrHT.get(i).getNama_client(), arrHT.get(i).getNomor_telepon_client(), arrHT.get(i).getTanggal_reservasi(), arrHT.get(i).getJam_reservasi(), arrHT.get(i).getJumlah_orang(), arrHT.get(i).getNote_transaksi(), arrHT.get(i).getTotal_harga(), arrHT.get(i).getId_restoran(), arrHT.get(i).getStatus_pesanan());
                                    arrHT2.add(ht);
                            ...
                            binding.rvLaporanPendapatanTahunanRestoran.setLayoutManager(new LinearLayoutManager(getActivity()));
                            LaporanPendapatanRestoranAdapter adapter = new LaporanPendapatanRestoranAdapter(arrHT2);
                            binding.rvLaporanPendapatanTahunanRestoran.setAdapter(adapter);
