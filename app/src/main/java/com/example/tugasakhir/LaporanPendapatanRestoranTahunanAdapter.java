...
public class LaporanPendapatanRestoranTahunanAdapter extends RecyclerView.Adapter<LaporanPendapatanRestoranTahunanAdapter.ViewHolder> {

    ArrayList<HeaderTransaksi> arrHT;
    OnItemClickCallback onItemClickCallback;

    public LaporanPendapatanRestoranTahunanAdapter(ArrayList<HeaderTransaksi> arrHT) {
        this.arrHT = arrHT;
    }
    ...
    @NonNull
    @Override
    public LaporanPendapatanRestoranTahunanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LaporanPendapatanRestoranTahunanAdapter.ViewHolder holder, int position) {
