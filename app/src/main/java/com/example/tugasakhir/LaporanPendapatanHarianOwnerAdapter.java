...
public class LaporanPendapatanHarianOwnerAdapter extends RecyclerView.Adapter<LaporanPendapatanHarianOwnerAdapter.ViewHolder> {

    ArrayList<HeaderTransaksi> arrHT;
    OnItemClickCallback onItemClickCallback;

    public LaporanPendapatanHarianOwnerAdapter(ArrayList<HeaderTransaksi> arrHT) {
        this.arrHT = arrHT;
    }
    ...
    @NonNull
    @Override
    public LaporanPendapatanHarianOwnerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LaporanPendapatanHarianOwnerAdapter.ViewHolder holder, int position) {
