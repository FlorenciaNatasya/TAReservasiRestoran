 ...
 * Use the {@link FragmentRestoranDiproses#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentRestoranDiproses extends Fragment {

    FragmentRestoranDiprosesBinding binding;
    ...
    public FragmentRestoranDiproses() {
        // Required empty public constructor
    }

    public static FragmentRestoranDiproses newInstance(String idresto) {
        FragmentRestoranDiproses fragment = new FragmentRestoranDiproses();
...
//        return inflater.inflate(R.layout.fragment_restoran_diproses, container, false);
        binding = FragmentRestoranDiprosesBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.rvFragmentRestoranDiproses.setHasFixedSize(true);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (arrHtrans != null) {
                                binding.rvFragmentRestoranDiproses.setLayoutManager(new LinearLayoutManager(getActivity()));
                                for (int i = 0; i < arrHtrans.size(); i++) {
                                    if(arrHtrans.get(i).getId_restoran().equalsIgnoreCase(idresto) && arrHtrans.get(i).getStatus_pesanan().equalsIgnoreCase("Dikonfirmasi")){
                                ...
                                binding.rvFragmentRestoranDiproses.setAdapter(adapter);
                            }
